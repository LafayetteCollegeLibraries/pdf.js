...
PDFJS.workerSrc = '/javascripts/pdf.js/build/pdf.worker.js';
...
document.addEventListener('DOMContentLoaded', function webViewerLoad(evt) {
  ...
  */
  ...
  document.getElementById('presentationMode').addEventListener('click', function(e) {
	  ...
	  // Resolves LDRHYDRA-68
	  if(typeof(Drupal) == 'undefined') {

	      var pathname = window.location.pathname;
	      var objectMatch = pathname.split('/');
	      var objectId = objectMatch[objectMatch.length - 1];

	      window.location.assign('/downloads/' + objectId);
	  } else {
